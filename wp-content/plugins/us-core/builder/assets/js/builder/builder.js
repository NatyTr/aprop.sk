...
!  function( $, undefined ) {
	...
	$.extend( prototype, {
		...
		_getEventData: function( e ) {
			...
			var rect = $usbcore.$rect( $usb.iframe ),
		...
		_endDrag: function( e ) {
			...
			// Remove classes
			if ( $usbcore.isNode( dragData.target ) ) {
				$usbcore
	...
	$.extend( prototype, {
		...
		removeElm: function( removeId ) {
			...
			if ( rootContainerId ) {
				...
				$usb.postMessage( 'vcColumnChange', /* row|row_inner id */rootContainerId );
			}
