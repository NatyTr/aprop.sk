...
var $usb=parent.$usb,$usbcore=parent.$usbcore||{};var _COOKIE_NAME_FOR_PREVIEW_OPTIONS_='usb_preview_site_options';var USBSitePreview=function(){var self=this;var siteParam=$usb.config('preview.url_site_param');if(siteParam&&(_document.referrer+'').indexOf(siteParam)>-1){var siteNonce=$usb.config('preview.url_site_nonce','');var url=new URL(location);url.searchParams.set(siteParam,siteNonce);_history.pushState({},'',url.toString())}
